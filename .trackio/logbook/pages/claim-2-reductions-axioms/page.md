# Claim 2 — Reductions & axioms


---
<!-- trackio-cell
{"type": "code", "id": "cell_24319434dd7d", "created_at": "2026-07-17T05:33:21+00:00", "title": "Full evidence (C1+C2+C3)", "command": ["python", "repro/src/run_claims.py"], "exit_code": 0, "duration_s": 3.012}
-->
````bash
...
=== C1 ===
{
  "claim": "C1 PASV = precedence + soft weights",
  "all_enforce_precedence": true,
  "all_weights_active": true
}
=== C2 ===
{
  "claim": "C2 reductions + axioms",
  "worst_Prop3.1_PSV": 0.0,
  "worst_Prop3.2_WSV": 0.0,
  "worst_efficiency": 1.7763568394002505e-15,
  "worst_linearity": 1.7763568394002505e-15,
  "worst_null_player": 0.0,
  "classical_SV_reduction_err": 0.0,
  "all_machine_precision": true
}
=== C3 ===
{
  "claim": "C3 MCMC sampler",
  "worst_tv_to_stationary": 0.017108241758241733,
  "worst_value_err": 1.3322676295501878e-15,
  "converges": true
}

Wrote c1_definition.csv, c2_reductions_axioms.csv, c3_mcmc.csv, summary.json
...
---
<!-- trackio-cell
{"type": "artifact", "id": "cell_d36d4fb75b8d", "created_at": "2026-07-17T05:33:21+00:00", "title": "Artifact: c2_reductions_axioms.csv", "path": "outputs/c2_reductions_axioms.csv", "size": 373, "artifact_type": "dataset", "auto": true}
-->
...
---
<!-- trackio-cell
{"type": "artifact", "id": "cell_f6dc4ce930f9", "created_at": "2026-07-17T05:33:21+00:00", "title": "Artifact: c1_definition.csv", "path": "outputs/c1_definition.csv", "size": 318, "artifact_type": "dataset", "auto": true}
-->
...
---
<!-- trackio-cell
{"type": "artifact", "id": "cell_01f95aaffe2f", "created_at": "2026-07-17T05:33:21+00:00", "title": "Artifact: c3_mcmc.csv", "path": "outputs/c3_mcmc.csv", "size": 316, "artifact_type": "dataset", "auto": true}
-->
...
---
<!-- trackio-cell
{"type": "markdown", "id": "cell_ea9fc41ef79c", "created_at": "2026-07-17T05:34:07+00:00", "title": "C2: reductions to PSV/WSV + Shapley axioms (machine precision)"}
-->
**Claim 2 (Props 3.1/3.2 + Thms 3.8/3.12):** PASV is uniquely characterized by the axioms and recovers the precedence-only (PSV) and weight-only (WSV) Shapley variants as special cases.

| test | worst error |
|---|---|
| **Prop 3.1** const-λ ⟹ PSV (uniform over Π_≺) | **0.0** |
| **Prop 3.2** ordered-partition DAG ⟹ WSV (backward λ-sampling) | **0.0** |
| Axiom E (Efficiency) Σψᵢ = U([n]) | 1.8e-15 |
| Axiom L (Linearity) ψ(aU+bV)=aψ(U)+bψ(V) | 1.8e-15 |
| Axiom NP (Null player) ψᵢ=0 if i irrelevant | 0.0 |
| Bonus: no-precedence + const-λ ⟹ **classical Shapley** | 0.0 |

The crucial |max_≺(S_t)| factor in eq. (4) (Remark 3.3) is what makes the const-λ reduction land on uniform PSV — we confirm that the naive WSV formula applied to general posets would *not* reduce to PSV (the factor is essential).
