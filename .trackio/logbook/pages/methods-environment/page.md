...
---
<!-- trackio-cell
{"type": "code", "id": "cell_19abfbb75280", "created_at": "2026-07-17T05:33:16+00:00", "title": "Pytest suite (21 tests)", "command": ["python", "-m", "pytest", "repro/tests/test_pasv.py", "-q"], "exit_code": 0, "duration_s": 2.523}
-->
````bash
...
- `pasv.py` — poset + linear-extension enumeration, **PASV distribution (eq 4)**, PSV, WSV (backward λ-sampling), PASV/PSV values, classical Shapley.
- `mcmc.py` — adjacent-swap Metropolis-Hastings sampler for p^(≺,λ).
